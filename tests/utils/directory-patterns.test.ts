...
describe("Directory Selection Patterns", () => {
  describe("PathResolver Integration", () => {
    ...
    it("should maintain consistency between getPathPrefix and buildComponentPath", () => {
      ...
      components.forEach((component) => {
        ...
        const actualPath = PathResolver.buildComponentPath(
          baseDir,
          component,
          false,
        );
      ...
      const testCases = [
        {
          baseDir: "/project",
          global: false,
          expected: join("/project", ".claude", "skills"),
        },
        {
        ...
        },
        {
          baseDir: "/tmp/test",
          global: false,
          expected: join("/tmp/test", ".claude", "skills"),
        },
      ];
  ...
  describe("Pattern Matching Scenarios", () => {
    ...
    it("should maintain backward compatibility for local mode", () => {
      ...
      const localAgentsPath = PathResolver.buildComponentPath(
        "/project",
        "agents",
        false,
      );
    ...
    it("should support global mode without prefix", () => {
      ...
      const globalSkillsPath = PathResolver.buildSkillsPath(
        "/home/user/.claude",
        true,
      );
