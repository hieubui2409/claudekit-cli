...
describe("Types and Schemas", () => {
  ...
  describe("ExcludePatternSchema", () => {
    ...
    test("should reject absolute paths", () => {
      ...
      expect(() => ExcludePatternSchema.parse("/var/log/**")).toThrow(
        "Absolute paths not allowed",
      );
    });
    ...
    test("should reject empty patterns", () => {
      expect(() => ExcludePatternSchema.parse("")).toThrow(
    ...
    test("should reject overly long patterns", () => {
      ...
      expect(() => ExcludePatternSchema.parse(longPattern)).toThrow(
        "Exclude pattern too long",
      );
    });
  ...
  describe("GitHubReleaseSchema", () => {
    test("should validate complete release", () => {
      const release = {
        ...
        tarball_url:
          "https://api.github.com/repos/test/test-repo/tarball/v1.0.0",
        zipball_url:
          "https://api.github.com/repos/test/test-repo/zipball/v1.0.0",
      };
