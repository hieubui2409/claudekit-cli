...
describe("VersionFormatter", () => {
  ...
  describe("formatRelativeTime", () => {
    ...
    it("should format minutes ago", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(fiveMinutesAgo)).toBe(
        "5 minutes ago",
      );
    });
    ...
    it("should format hours ago", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(twoHoursAgo)).toBe(
        "2 hours ago",
      );
    });
    ...
    it("should format days ago", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(threeDaysAgo)).toBe(
        "3 days ago",
      );
    });
    ...
    it("should format weeks ago", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(twoWeeksAgo)).toBe(
        "2 weeks ago",
      );
    });
    ...
    it("should format months ago", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(twoMonthsAgo)).toBe(
        "2 months ago",
      );
    });
    ...
    it("should return Unknown for invalid date", () => {
      expect(VersionFormatter.formatRelativeTime("invalid-date")).toBe(
        "Unknown",
      );
    });
    ...
    it("should handle singular forms", () => {
      ...
      expect(VersionFormatter.formatRelativeTime(oneMinuteAgo)).toBe(
        "1 minute ago",
      );
      ...
      expect(VersionFormatter.formatRelativeTime(oneHourAgo)).toBe(
        "1 hour ago",
      );
