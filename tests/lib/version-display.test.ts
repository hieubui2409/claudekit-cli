...
describe("VersionDisplayFormatter", () => {
  ...
  describe("isValidVersionChoice", () => {
    ...
    it("should return false for separator", () => {
      expect(VersionDisplayFormatter.isValidVersionChoice("separator")).toBe(
        false,
      );
    });

    it("should return false for cancel", () => {
      expect(VersionDisplayFormatter.isValidVersionChoice("cancel")).toBe(
        false,
      );
    });
  ...
  describe("formatError", () => {
    ...
    it("should include suggestion when provided", () => {
      const error = VersionDisplayFormatter.formatError(
        "Test error",
        "Try this instead",
      );
      expect(error).toContain("Test error");
