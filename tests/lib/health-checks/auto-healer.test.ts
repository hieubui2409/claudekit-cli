  ...
  describe("healAll", () => {
    test("executes fixes for fixable failed checks", async () => {
      ...
      const mockExecute = mock(() =>
        Promise.resolve({ success: true, message: "Fixed" }),
      );
    ...
    test("handles fix execution failure", async () => {
      const healer = new AutoHealer({ timeout: 5000 });
      const mockExecute = mock(() =>
        Promise.resolve({ success: false, message: "Fix failed" }),
      );
      ...
      const checks: CheckResult[] = [
        {
          ...
          fix: {
            ...
            description: "Fix 1",
            execute: () =>
              Promise.resolve({ success: true, message: "Fixed 1" }),
          },
        },
        {
          id: "fix-2",
          ...
          fix: {
            ...
            description: "Fix 2",
            execute: () =>
              Promise.resolve({ success: true, message: "Fixed 2" }),
          },
        },
        {
          id: "fix-3",
          ...
          fix: {
            ...
            description: "Fix 3",
            execute: () =>
              Promise.resolve({ success: false, message: "Failed 3" }),
          },
        },
      ];
