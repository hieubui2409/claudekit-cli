  ...
  describe("getDownloadableAsset", () => {
    test("should prioritize ClaudeKit Engineer Package zip file", () => {
        ...
        assets: [
          ...
          },
          {
            ...
            browser_download_url:
              "https://github.com/test/claudekit-package.zip",
            size: 2048,
      ...
      expect(result.url).toBe(
        "https://api.github.com/repos/test/repo/releases/assets/2",
      );
      ...
      const release: GitHubRelease = {
        ...
        assets: [
          ...
          },
          {
            ...
            url: "https://api.github.com/repos/test/repo/releases/assets/2",
            browser_download_url:
              "https://github.com/test/marketing-package.zip",
            size: 2048,
            content_type: "application/zip",
          },
        ],
    ...
    test("should fallback to GitHub automatic tarball if no assets", () => {
      ...
      expect(result.url).toBe(
        "https://api.github.com/repos/test/repo/tarball/v1.0.0",
      );
