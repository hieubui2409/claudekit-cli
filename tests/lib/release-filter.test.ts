...
const createMockEnrichedRelease = (
  overrides: Partial<EnrichedRelease> = {},
): EnrichedRelease => ({
  id: 1,
  tag_name: "v1.0.0",
  name: "Release 1.0.0",
...
describe("ReleaseFilter", () => {
  ...
  describe("tagLatest", () => {
    ...
    it("should not mutate original array", () => {
      const releases = [
        createMockEnrichedRelease({ id: 1, tag_name: "v1.0.0" }),
      ];
    ...
    it("should return releases within specified days", () => {
      ...
      const releases = [
        ...
        createMockRelease({
          id: 2,
          tag_name: "v0.9.0",
          published_at: sixtyDaysAgo.toISOString(),
        }),
      ];
  ...
  describe("getLatestPrerelease", () => {
    it("should return highest semver prerelease", () => {
      const releases = [
        createMockRelease({
          id: 1,
          tag_name: "v2.1.0-beta.9",
          prerelease: true,
          draft: false,
        }),
        createMockRelease({
          id: 2,
          tag_name: "v2.1.0-beta.10",
          prerelease: true,
          draft: false,
        }),
        createMockRelease({
    ...
    it("should select beta.10 over beta.9 regardless of API order (issue #256)", () => {
      ...
      const releasesInGitHubApiOrder = [
        ...
        createMockRelease({
          id: 6,
          tag_name: "v2.1.0-beta.6",
          prerelease: true,
          draft: false,
        }),
        createMockRelease({
          id: 5,
          tag_name: "v2.1.0-beta.5",
          prerelease: true,
          draft: false,
        }),
        createMockRelease({
      ...
      const latest = ReleaseFilter.getLatestPrerelease(
        releasesInGitHubApiOrder,
      );
