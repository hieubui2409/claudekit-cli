  ...
  describe("Release Data Handling", () => {
    ...
    test("should handle draft release", () => {
      const release: GitHubRelease = {
        ...
        assets: [],
        tarball_url:
          "https://api.github.com/repos/owner/repo/tarball/v1.0.0-draft",
        zipball_url:
          "https://api.github.com/repos/owner/repo/zipball/v1.0.0-draft",
      };
    ...
    test("should handle prerelease", () => {
      const release: GitHubRelease = {
        ...
        assets: [],
        tarball_url:
          "https://api.github.com/repos/owner/repo/tarball/v1.0.0-beta.1",
        zipball_url:
          "https://api.github.com/repos/owner/repo/zipball/v1.0.0-beta.1",
      };
  ...
  describe("Release Filtering", () => {
    const releases: GitHubRelease[] = [
      ...
      },
      {
        ...
        tarball_url:
          "https://api.github.com/repos/owner/repo/tarball/v1.1.0-beta.1",
        zipball_url:
          "https://api.github.com/repos/owner/repo/zipball/v1.1.0-beta.1",
      },
      {
        id: 3,
        ...
        tarball_url:
          "https://api.github.com/repos/owner/repo/tarball/v1.2.0-draft",
        zipball_url:
          "https://api.github.com/repos/owner/repo/zipball/v1.2.0-draft",
      },
    ];
