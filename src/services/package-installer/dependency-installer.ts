...
import {
  NODEJS_INSTALLERS,
  getNodejsInstructions,
} from "./dependencies/node-installer.js";
import {
  PYTHON_INSTALLERS,
  getPythonInstructions,
} from "./dependencies/python-installer.js";
import {
  CLAUDE_INSTALLERS,
  type OSInfo,
  detectOS,
...
export function getManualInstructions(
  ...
  if (dependency === "python" || dependency === "pip")
    return getPythonInstructions(osInfo);
