  ...
  const categories = [
    {
      key: "agents",
      label: "Agents",
      pattern: prefix ? `${prefix}/agents` : "agents",
    },
    {
      key: "commands",
      label: "Commands",
      pattern: prefix ? `${prefix}/commands` : "commands",
    },
    {
      key: "workflows",
      label: "Workflows",
    ...
    },
    {
      key: "skills",
      label: "Skills",
      pattern: prefix ? `${prefix}/skills` : "skills",
    },
    {
      key: "hooks",
      label: "Hooks",
      pattern: prefix ? `${prefix}/hooks` : "hooks",
    },
  ];
...
export async function promptFreshConfirmation(
  ...
  logger.warning(
    "[!] WARNING: Fresh installation will completely remove the .claude directory!",
  );
  logger.info(`Path: ${targetPath}`);
  logger.info(
    "All custom files, configurations, and modifications will be permanently deleted.",
  );
